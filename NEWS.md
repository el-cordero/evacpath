...
* Replaced the Jakarta vignette with a thorough function-by-function diagnostic workflow.
* Copied the diagnostic Rmd to the package root as `jakarta-example-diagnostics.Rmd` and to `inst/examples/`.
