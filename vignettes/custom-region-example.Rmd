...
description: "Adapt the workflow to local hazard, road, elevation, and planning inputs."
...
For context, this is the model result returned by a compact run using the
packaged inputs. A new region should be interpreted only after its own input
and QA/QC review.

```{r custom-region-time-figure, echo = FALSE, eval = TRUE, results = "asis"}
figure_html("pkgdown-example-time.png", "Modeled evacuation time to safety for the compact packaged example.")
```

```{r regional-result, echo = FALSE, eval = TRUE}
